...
# Run models
expectedWaitTime1 = launchModel(events = events, tasks = tasks, queue = FifoQueue(numberJudges = 1))
expectedWaitTime2 = launchModel(events = events, tasks = tasks, queue = OnlyAskQueue(numberJudges = 1))
